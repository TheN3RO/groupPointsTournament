...
const Group =({group, podium}) =>  {
  ...
  return (
    <div data-aos="fade-down-right" data-aos-duration={`${3000-(podium*1000)}`} className={`relative flex flex-col justify-center w-[300px] p-4 ${podium < 4 ? podiumClasses[podium][0] : styles['bg-default']}`}>
